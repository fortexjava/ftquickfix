...
public class DerivativeSecurityList extends Message {
	...
	public static class NoRelatedSym extends Group {
		...
		public NoRelatedSym() {
			super(146, 55,
				new int[] {55, 65, 48, 22, 454, 460, 461, 167, 762, 200, 541, 201, 224, 225, 239, 226, 227, 228, 255, 543, 470, 471, 472, 240, 202, 947, 206, 231, 223, 207, 106, 348, 349, 107, 350, 351, 691, 667, 875, 876, 864, 873, 874, 15, 827, 668, 869, 870, 555, 336, 625, 58, 354, 355,  0 });
		}
