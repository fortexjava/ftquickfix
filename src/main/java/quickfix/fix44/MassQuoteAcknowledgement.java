...
public class MassQuoteAcknowledgement extends Message {
	...
	public static class NoQuoteSets extends Group {
		...
		public NoQuoteSets() {
			super(296, 302,
				new int[] {302, 311, 312, 309, 305, 457, 462, 463, 310, 763, 313, 542, 315, 241, 242, 243, 244, 245, 246, 256, 595, 592, 593, 594, 247, 316, 941, 317, 436, 435, 308, 306, 362, 363, 307, 364, 365, 877, 878, 318, 879, 810, 882, 883, 884, 885, 886, 887, 304, 893, 295,  0 });
		}
	...
	public static class NoQuoteEntries extends Group {
		...
		public NoQuoteEntries() {
			super(295, 299,
				new int[] {299, 55, 65, 48, 22, 454, 460, 461, 167, 762, 200, 541, 201, 224, 225, 239, 226, 227, 228, 255, 543, 470, 471, 472, 240, 202, 947, 206, 231, 223, 207, 106, 348, 349, 107, 350, 351, 691, 667, 875, 876, 864, 873, 874, 555, 132, 133, 134, 135, 62, 188, 190, 189, 191, 631, 632, 633, 634, 60, 336, 625, 64, 40, 193, 192, 642, 643, 15, 368,  0 });
		}
