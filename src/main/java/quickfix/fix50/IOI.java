...
public class IOI extends Message {
	...
	public static class NoLegs extends Group {
		...
		public NoLegs() {
			super(555, 600,
				new int[] {600, 601, 602, 603, 604, 605, 606, 607, 608, 609, 764, 610, 611, 248, 249, 250, 251, 252, 253, 257, 599, 596, 597, 598, 254, 612, 942, 613, 614, 615, 616, 617, 618, 619, 620, 621, 622, 623, 624, 556, 740, 739, 955, 956, 999, 1001, 682, 683,  0 });
		}
