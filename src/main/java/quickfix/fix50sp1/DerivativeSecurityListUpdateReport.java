...
public class DerivativeSecurityListUpdateReport extends Message {
	...
	public static class NoDerivativeEvents extends Group {
		...
		public NoDerivativeEvents() {
			super(1286, 1287,
				new int[] {1287, 1288, 1289, 1290, 1291,  0 });
		}
	...
	public static class NoMarketSegments extends Group {
		...
		public NoMarketSegments() {
			super(1310, 1301,
				new int[] {1301, 1300, 1205, 1234, 1306, 1148, 1149, 1150, 827, 562, 1140, 1143, 1144, 1245, 561, 1377, 1378, 423, 1309, 1312, 1201,  0 });
		}
	...
	public static class NoTradingSessionRules extends Group {
		...
		public NoTradingSessionRules() {
			super(1309, 336,
				new int[] {336, 625, 1237, 1239, 1232, 1235, 1141,  0 });
		}
	...
	public static class NoStrikeRules extends Group {
		...
		public NoStrikeRules() {
			super(1201, 1223,
				new int[] {1223, 1202, 1203, 1204, 1304, 1236,  0 });
		}
	...
	public static class NoMaturityRules extends Group {
		...
		public NoMaturityRules() {
			super(1236, 1222,
				new int[] {1222, 1303, 1302, 1241, 1226, 1229,  0 });
		}
	...
	public static class NoRelatedSym extends Group {
		...
		public NoRelatedSym() {
			super(146, 1324,
				new int[] {1324, 292, 55, 65, 48, 22, 454, 460, 1227, 1151, 461, 167, 762, 200, 541, 1079, 966, 1049, 965, 224, 225, 239, 226, 227, 228, 255, 543, 470, 471, 472, 240, 202, 947, 967, 968, 206, 231, 969, 1146, 996, 1147, 1191, 1192, 1193, 1194, 1195, 1196, 1197, 1198, 1199, 1200, 201, 1244, 1242, 997, 223, 207, 970, 971, 106, 348, 349, 107, 350, 351, 1184, 1185, 1186, 691, 667, 875, 876, 864, 873, 874, 1018, 668, 869, 870, 1305, 1221, 1230, 1240, 15, 555, 58, 354, 355,  0 });
		}
	...
	public static class NoLegs extends Group {
		...
		public NoLegs() {
			super(555, 600,
				new int[] {600, 601, 602, 603, 604, 607, 608, 609, 764, 610, 611, 1212, 248, 249, 250, 251, 252, 253, 257, 599, 596, 597, 598, 254, 612, 942, 613, 614, 999, 1224, 1421, 1422, 1001, 1420, 615, 616, 617, 618, 619, 620, 621, 622, 623, 624, 556, 740, 739, 955, 956, 1358, 1017, 566,  0 });
		}
