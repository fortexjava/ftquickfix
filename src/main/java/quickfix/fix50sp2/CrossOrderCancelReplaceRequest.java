...
public class CrossOrderCancelReplaceRequest extends Message {
	...
	public static class NoSides extends Group {
		...
		public NoSides() {
			super(552, 54,
				new int[] {54, 41, 11, 526, 583, 453, 229, 75, 1, 660, 581, 589, 590, 591, 70, 78, 854, 38, 152, 516, 468, 469, 12, 13, 479, 497, 528, 529, 1091, 582, 121, 120, 775, 58, 354, 355, 77, 203, 544, 635, 377, 659, 962,  0 });
		}
